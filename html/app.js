  ...
  methods: {
    hudTick(data) {
      ...
      if (data.playerDead === false) {
        this.healthColor = "#EF2D56";
      } else {
        this.healthColor = "#FF3131";
        this.health = 100;
      }
      ...
      if (data.armor <= 0) {
        this.armorColor = "#FF3131";
      } else {
        this.armorColor = "#E5BEED";
      }
      ...
      if (data.hunger >= 100) {
        this.hungerColor = "#77BFA3";
      } else if(data.hunger <= 30){
        this.hungerColor = "#FF3131";
      } else{
        this.hungerColor = "#77BFA3";
      }
      ...
      if (data.thirst >= 100) {
        this.thirstColor = "#00A6ED";
      } else if(data.thirst <= 30){
        this.thirstColor = "#FF3131";
      } else{
        this.thirstColor = "#00A6ED";
      }
      ...
      if (data.engine <= 45) {
        this.engineColor = "#FF3131";
      } else if (data.engine <= 75 && data.engine >= 46 ) {
        this.engineColor = "#FFFF33";
      } else if(data.engine<=100) {
        this.engineColor = "#39FF14";
      } 
